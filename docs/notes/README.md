...
| [2026-08-22-studio-toolbar-hierarchy.md](2026-08-22-studio-toolbar-hierarchy.md) | 2026-08-22 | Live visual and hierarchy observation of top-of-window chrome (header_bar + actions_bar), radical rethink, and Phase III vote (DELETE global verb bank, KEEP session strip). |
