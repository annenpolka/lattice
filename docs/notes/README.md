...
| [2026-08-22-studio-toolbar-gen2-opus.md](2026-08-22-studio-toolbar-gen2-opus.md) | 2026-08-22 | One replacement for the deleted standing verb bank: a verb's control is drawn on its target or it is not drawn. Names routes for set-gain, set-fade, split, and delete; keeps the utterance disclosure-only; offers a membership test for the session strip. |
