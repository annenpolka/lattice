...
| [2026-08-22-studio-toolbar-structure.md](2026-08-22-studio-toolbar-structure.md) | 2026-08-22 | Structure of the live top chrome after the integrated spine: `header_bar` + wrapping `actions_bar`, and who owns each control's state. |
