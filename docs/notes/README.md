...
| [2026-08-22-studio-toolbar-gen2-pair.md](2026-08-22-studio-toolbar-gen2-pair.md) | 2026-08-22 | Isolated pair after the locus-taking toolbar bank is deleted: Local-Projection Commit Homes vs Command Ledger. Routes `set-gain` / `set-fade` / `split` / `delete`. No winner. |
