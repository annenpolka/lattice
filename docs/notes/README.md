...
| [2026-08-22-studio-toolbar-hierarchy.md](2026-08-22-studio-toolbar-hierarchy.md) | 2026-08-22 | Live visual and hierarchy observation of top-of-window chrome (header_bar + actions_bar), plus radical-rethink on whether a global verb button row belongs under the locked spine. |
