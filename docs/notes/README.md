...
| [2026-08-22-studio-toolbar-first-principles.md](2026-08-22-studio-toolbar-first-principles.md) | 2026-08-22 | First-principles rethink, against Engine / `SemanticEdit` / legal set, of whether a global top-of-window verb button row is the right object under the locked spine. Answer: no — a fixed global verb set can be correct for at most one of eight locus kinds, and correcting the row converges on the Inspector. Ends with a Phase III vote (§12): DELETE the object, STEAL the verbs, keep a session strip whose membership is a predicate. Read live at 85b589e. Rethink and vote, not a design. |
