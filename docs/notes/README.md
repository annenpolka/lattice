...
| [2026-08-22-studio-toolbar-structure.md](2026-08-22-studio-toolbar-structure.md) | 2026-08-22 | Structure of the live top chrome after the integrated spine, a radical rethink of the global verb row, and a Phase III vote (DELETE the locus-taking bank; name a session strip). |
