...
| [2026-08-22-studio-toolbar-gen2-control.md](2026-08-22-studio-toolbar-gen2-control.md) | 2026-08-22 | CONTROL candidate only: honest current Studio chrome minus the six locus-taking verb-bank buttons. Thin session strip. set-gain / set-fade / split / delete are unrouted. Utterance stays disclosure-only. Not a winner. |
