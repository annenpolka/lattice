...
| [2026-08-22-studio-toolbar-first-principles.md](2026-08-22-studio-toolbar-first-principles.md) | 2026-08-22 | Live observation of the top-of-window button row after the verb-license spine, read only against Engine / `SemanticEdit` / legal set: the row is byte-identical across loci with disjoint legal sets, and the constraints that follow for an Engine client. Observation, not a design. |
