...
| [2026-08-22-studio-toolbar-semantics.md](2026-08-22-studio-toolbar-semantics.md) | 2026-08-22 | Docs-only observation of the current top-of-window row: toolbar labels versus Engine legality, projection routing, and the one utterance. |
