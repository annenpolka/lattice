...
| [2026-08-22-studio-toolbar-interaction.md](2026-08-22-studio-toolbar-interaction.md) | 2026-08-22 | Interaction lens on the current top chrome after that spine: a global verb BUTTON ROW is the wrong object (gesture is routing; verbs belong where the projection commits, or stay spoken). Phase III: DELETE the locus-taking edit bank; KEEP a session strip; no shipping winner. |
