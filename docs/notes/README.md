...
| [2026-08-22-studio-toolbar-semantics.md](2026-08-22-studio-toolbar-semantics.md) | 2026-08-22 | Domain-semantics review of whether Studio should have a global verb button row at all; concludes that Timeline, Canvas, and Inspector own commit routes while the global account speaks legality. |
